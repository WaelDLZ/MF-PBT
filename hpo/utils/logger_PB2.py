...
class Logger:
    ...
    def read_logs(self):
        ...
        history = pickle.load(open(os.path.join(self.logging_path, f"round_{round_index}_history.pkl"), "rb"))  # noqa: SIM115
        ...
        return True, round_index, log_df, agent_params, history

    def write_logs(self, agents, round_index: int, history: dict):
        pickle.dump(history, open(os.path.join(self.logging_path, f"round_{round_index}_history.pkl"), "wb"))  # noqa: SIM115
